...
// Seat Component
const Seat = ({style,backrestStyle, seatAreaStyle, onClick, rotate = 0 }) => {
...
const Partition = styled(Box)({
  ...
  margin: '0px',
  boxShadow: `
    inset 0 2px 4px rgba(0, 0, 0, 0.15), // Softer inner shadow with reduced blur and opacity
    0 3px 3px rgba(0, 0, 0, 0.08), // Lighter outer shadow with reduced opacity and size
    0 4px 2px rgba(255, 255, 255, 0.15) // Subtle light reflection with reduced blur and opacity
  `,
